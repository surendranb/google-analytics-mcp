...
### Fixed
- Added exact `error_message` context to the `mcp_started` boot telemetry payload to eliminate blindspots regarding why user configurations fail (previously only `config_status` was captured).
